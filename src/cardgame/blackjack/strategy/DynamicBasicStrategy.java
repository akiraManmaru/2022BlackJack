...
public class DynamicBasicStrategy implements State {

	private DynamicStrategy dynamicStrategy;
	private final Strategy strategy = new BasicStrategy();
	private String STRATEGY_NAME = "DynamicBasicStrategy";

	public DynamicBasicStrategy(DynamicStrategy dynamicStrategy) {
